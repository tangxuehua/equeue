...
namespace EQueue.Protocols
{
    ...
    public class QueueMessage : Message
    {
        ...
        public QueueMessage(string messageId, string topic, int code, string key, byte[] body, long messageOffset, int queueId, long queueOffset, DateTime createdTime, DateTime storedTime, string routingKey)
